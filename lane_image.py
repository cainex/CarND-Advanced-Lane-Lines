...
class lane_image:
    ...
    def __init__(self, cam_params, filename):
        ...
        height = 80
        margin = 100
        self.centroids = self.find_window_centroids(self.images['transform_grad'], width, height, margin)
        print(self.centroids)
        self.images['centroids'] = self.add_centroids_to_image(self.images['transform_grad'], self.centroids, width, height)
